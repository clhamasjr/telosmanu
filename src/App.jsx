...
export default function App() {
  ...
  // Define which pages each profile can access
  const canAccess = {
    admin: ['dashboard','ordens','equipamentos','mecanicos','pecas','areas','preventiva','relatorios','usuarios'],
    gestor: ['dashboard','ordens','equipamentos','mecanicos','pecas','areas','preventiva','relatorios'],
    mecanico: ['dashboard','ordens','equipamentos','pecas'],
    solicitante: ['dashboard','ordens'],
    visualizador: ['dashboard','ordens','equipamentos'],
  }
  const allowed = canAccess[perfil] || canAccess.visualizador
