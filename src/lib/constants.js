...
export const EQUIP_STATUS = ['Operando','Parado','Em Manutenção','Com Interferência','Desativado']
...
export const PERFIS_CONFIG = {
  admin: {
    ...
    paginas: ['dashboard','ordens','equipamentos','mecanicos','pecas','areas','mapa','preventiva','relatorios','descricoes','usuarios'],
    permissoes: {
  ...
  gestor: {
    ...
    paginas: ['dashboard','ordens','equipamentos','mecanicos','pecas','areas','mapa','preventiva','relatorios','descricoes'],
    permissoes: {
  ...
  supervisor: {
    ...
    paginas: ['dashboard','ordens','equipamentos','mecanicos','pecas','areas','mapa','relatorios'],
    permissoes: {
  ...
  mecanico: {
    ...
    paginas: ['dashboard','ordens','equipamentos','pecas','mapa'],
    permissoes: {
  ...
  visualizador: {
    ...
    paginas: ['dashboard','ordens','equipamentos','mapa'],
    permissoes: {
